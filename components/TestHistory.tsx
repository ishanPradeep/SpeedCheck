        ...
        <div className="flex space-x-2">
          {onRefresh && (
            <Button 
              ...
              variant="outline"
              size="sm"
              className={`border-blue-500/50 text-blue-400 hover:bg-blue-500/10 transition-all duration-300 transform hover:scale-105`}
            >
          ...
          <Button 
            ...
            variant="outline"
            size="sm"
            className={`border-red-500/50 text-red-400 hover:bg-red-500/10 transition-all duration-300 transform hover:scale-105`}
          >
        ...
        <CardContent className="p-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className={`text-center p-4 rounded-lg border ${
              ...
              <div className="text-3xl font-bold text-green-400 mb-1">{avgDownload}</div>
            ...
            <div className={`text-center p-4 rounded-lg border ${
              ...
              <div className="text-3xl font-bold text-blue-400 mb-1">{avgUpload}</div>
              <div className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-2`}>
                Avg Upload
              </div>
              {trends && (
